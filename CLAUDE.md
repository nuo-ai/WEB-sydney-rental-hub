...
- **代码注释用中文**解释："什么"，"为什么" ，以帮助我学习

## **标准工作流程**

1. 首先，思考问题，阅读代码库中的相关文件，并将计划写入 todo.md。
2. 该计划应包含一份待办事项清单，完成时可逐项勾选。
3. 开始工作前，先向我确认，我会核实该计划。
4. 然后，根据待办事项开始工作，每完成一项就标记为已完成。
5. 请在整个过程中，仅向我简要说明你所做的改动。
6. 你所执行的每项任务和代码修改都应尽可能简单。我们要避免任何大规模或复杂的改动。每次修改应尽量少影响代码。一切都以简洁为目标。
7. 最后，在 todo.md 文件中添加一个“回顾”小节，总结你所做的改动及任何其他相关信息。
